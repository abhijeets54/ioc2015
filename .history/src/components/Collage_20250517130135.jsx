  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent flex items-center">
        ...
        <motion.button
          className="absolute left-6 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white rounded-full p-3 backdrop-blur-sm transition-all duration-300 focus:outline-none"
        ...
        <motion.button
          className="absolute right-6 top-1/2 transform -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white rounded-full p-3 backdrop-blur-sm transition-all duration-300 focus:outline-none"
          onClick={handleNext}
          initial={{ opacity: 0, x: 10, scale: 0.9 }}
          animate={{ opacity: 0.8, x: 0, scale: 1 }}
          transition={{ delay: 1.5, duration: 0.8, ease: "easeOut" }}
        ...
        <motion.div 
          className="fixed right-10 top-1/2 transform -translate-y-1/2 flex flex-col space-y-5"
        ...
        >
          {[
            ...
            <motion.button
              ...
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 1.7 + index * 0.2, duration: 0.8, ease: "easeOut" }}
              whileHover={{ 
                scale: 1.1, 
