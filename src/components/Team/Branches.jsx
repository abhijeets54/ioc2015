...
import ludhianaImage from '/IOC Website pictures/branches/ludhiana.webp'; // Replace with actual path
import delhiImage from '/IOC Website pictures/branches/delhi.webp'; // Replace with actual path
import canadaImage from '/IOC Website pictures/branches/canada.webp'; // Replace with actual path
