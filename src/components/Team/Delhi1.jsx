...
import ajeetsingh from '/IOC Website pictures/ioc website content/team/teamheads/ajeet.webp'; // Replace with actual path
import jasleen from '/IOC Website pictures/ioc website content/team/teamheads/jasleen.webp'; // Replace with actual path
